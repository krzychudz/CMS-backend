...
router.get('/api/:user_id/blog-post/post_id', BlogPostController.getUserPost) // Get paticualr post
...
router.delete('/api/:user_id/blog-post/:post_id', BlogPostController.updatePost); // Remove paticular post
